...
class Display:
    def __init__(self, *args):
        ...
        self.WIDTH = 128
        self.HEIGHT = 64 #32  # Change to 64 if needed
    ...
    def deinit(self):
        # release display from prior boot
        # displayio.release_displays()
        print("Deinnitting Display. not release_displays().")
...
#     inner_bitmap = displayio.Bitmap(d.WIDTH - BORDER * 2, d.HEIGHT - BORDER * 2, 1)
...
#         terminalio.FONT, text=text, color=0xFFFFFF, x=28, y=d.HEIGHT // 2 - 1
#     )
